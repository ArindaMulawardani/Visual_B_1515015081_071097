...
//    }
    ...
    private void initComponents() {
        ...
        penulis.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Tere Liye", "Ilana Tan", "Raditya Dika", "J.K Rowling", "Asri Tahir" }));
    ...
    private void btnubahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnubahActionPerformed
        ...
        table.setValueAt(txtjudul.getText(),baris,0);
        table.setValueAt(penulis.getSelectedItem(),baris,1);
        table.setValueAt(txtharga.getText(),baris,2);
